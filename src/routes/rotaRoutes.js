 ...
 *                    example: "Erro interno do servidor"
 *    delete:
 *      summary: Deleta todos os atributos de uma rota existente no banco de dados.
 *      tags:
 *        - Rotas
 *      security:
 *        - bearerAuth: []
 *      description: Esta função é responsável por uma rota existente no banco de dados, verificando previamente se o usuário tem permissão para realizar a ação
 *      requestBody:
 *        required: true
 *        content:
 *          application/json:
 ...
 *        - in: path
 *          name: id
 *          description: ID da rota a ser deletada
 *          required: true
 *          schema:
 *            type: string
 *      responses:
 ...
 *        '400':
 *          description: Erro ao deletar a rotas
 *          content:
 *            application/json:
 *              schema:
 *                type: object
